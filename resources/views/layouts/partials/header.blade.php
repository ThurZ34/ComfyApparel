<header
    ...
    <div class="flex items-center gap-4">
        ...
        <button @click="sidebarOpen = true" class="text-zinc-500 hover:text-zinc-900 md:hidden focus:outline-none">
        ...
        <div class="relative" x-data="{ open: false }">
            <button @click="open = !open" @click.outside="open = false"
                ...
                <div class="hidden md:block text-left">
                    <p class="text-sm font-semibold text-zinc-900 group-hover:text-comfy-800">{{ Auth::user()->name }}
                    </p>
                </div>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-100"
                ...
                <div class="px-4 py-2 border-b border-zinc-100">
                    <p class="text-sm text-zinc-900 font-semibold">{{ Auth::user()->name }}</p>
