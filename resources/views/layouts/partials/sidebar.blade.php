        ...
        <nav class="flex-1 overflow-y-auto py-6 px-3 space-y-2">
           ...
           {{ request()->routeIs('topup-admin.index') ? 'bg-comfy-800 text-white font-semibold shadow-md shadow-comfy-800/20' : 'text-zinc-500 hover:bg-comfy-50 hover:text-comfy-800' }}">
            ...
            <a href="{{ route('laporan.index') }}"
                class="flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-200 group
           {{ request()->routeIs('laporan.*') ? 'bg-comfy-800 text-white font-semibold shadow-md shadow-comfy-800/20' : 'text-zinc-500 hover:bg-comfy-50 hover:text-comfy-800' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <a href="{{ route('pengaturan.index') }}"
                class="flex items-center gap-3 px-3 py-3 rounded-lg transition-all duration-200 group
           {{ request()->routeIs('pengaturan.index') ? 'bg-comfy-800 text-white font-semibold shadow-md shadow-comfy-800/20' : 'text-zinc-500 hover:bg-comfy-50 hover:text-comfy-800' }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round"
