...
@section('title', $produk->nama . ' - ComfyApparel')
                ...
                <div class="aspect-[4/5] w-full overflow-hidden rounded-2xl bg-zinc-100 relative group">
                    ...
                    <div class="absolute top-4 left-4 flex flex-col gap-2">
                        ...
                        @if ($produk->created_at->diffInDays(now()) < 7)
                            <span class="bg-comfy-800 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-sm">
                                New Arrival
                            </span>
                        @endif
                    </div>
                ...
                <form class="mt-10" x-data="{
                    ...
                    <div class="mt-10 flex flex-col sm:flex-row gap-4">
                        ...
                        <div class="flex items-center border border-zinc-200 rounded-full w-max">
                            <button type="button" class="px-4 py-3 text-zinc-600 hover:text-comfy-800 transition-colors"
